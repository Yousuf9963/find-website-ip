...
print("[+] Tool Name:phone-num-info")
...
print("Getting IP Address attacking........")
print("Getting IP Address  0%")
print("Getting IP Address  10%")
print("Getting IP Address  20%")
print("Getting IP Address  40%")
print("Getting IP Address  60%")
print("Getting IP Address  70%")
print("Getting IP Address  80%")
print("Getting IP Address  90%")
